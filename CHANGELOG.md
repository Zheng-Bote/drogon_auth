...
- **C++ Standard**: Bumped project and dependencies to strictly use C++26 standard.
- **Drogon APIs**: Replaced deprecated `createDbClient` calls with `addDbClient` in `main.cpp`.
